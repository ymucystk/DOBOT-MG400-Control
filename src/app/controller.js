...
export default function Controller(props) {
  ...
  const {j0_rotate, j1_rotate, j3_rotate} = props
  ...
  const set_j0_rotate = (e)=>{
    let value = e.target.value
    if(Math.abs(value)===180){
      value = value * -1
    }
    props.set_j0_rotate(value)
  }
    ...
    <>
      <div className="controller" >
        <div className="row mb-2">
          <div className="col-md-4"><label htmlFor="j0_rotate_number" className="form-label"><span className="form-control-plaintext">J0 Deg</span></label></div>
          <div className="col-md-8"><input type="number" className="form-control" id="j0_rotate_number" value={j0_rotate} onChange={set_j0_rotate} min={-180} max={180}/></div>
        </div>
        <div className="row mb-2">
